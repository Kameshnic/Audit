...
const UserDashboard = () => {
  ...
  return (
    ...
    <Box className="flex flex-col md:flex-row gap-4">
      <Box className="p-2 bg-white shadow-md rounded-md flex-1 max-w-full md:max-w-[600px]">
      ...
      <Box className="p-2 bg-white shadow-md rounded-md flex-1 max-w-full">
        <Typography variant="h6" gutterBottom>
          Registered Audits
        </Typography>
        <Divider sx={{ mb: 2 }} />
                      ...
                      <div className="w-full md:w-96 h-[100px] border border-gray-300 rounded-md bg-white p-4 overflow-y-scroll shadow-md mb-2">
                        {filtered[0].chat.length > 0 ? (
                          filtered[0].chat.map((chat, inde) => {
                            ...
                            return (
                              <div key={inde} className={`p-2 mb-2 text-sm text-gray-800 ${ alignment === 'u' ? 'rounded-md rounded-bl-none bg-green-200 mr-32' : alignment === 'a' ? 'rounded-md rounded-tr-none bg-red-200 ml-32' : 'rounded-md' }`} >
                                {message}
                              </div>
                            );
                          })
